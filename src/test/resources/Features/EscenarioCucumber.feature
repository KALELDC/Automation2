...
#      | name2 |     7 | Fail    |
@tag
Feature: Prueba con cucumber
  Esta es una prueba realizada con gherkin cucumber y java clase 9

  @tag1
  Scenario: Primera prueba con cucumber
    Given Dada una lista de números
    And el usuario ingresa el numero 5
    And el usuario ingresa el numero 6
